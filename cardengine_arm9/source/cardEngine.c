...
#define CACHE_ADRESS_SIZE 0x800000
#define CACHE_SLOTS 0x80
...
static u32 only_cacheDescriptor [CACHE_SLOTS];
static u32 only_cacheCounter [CACHE_SLOTS];
